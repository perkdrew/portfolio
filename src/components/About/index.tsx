        ...
        <div className="heading">
          ...
          <div className="description">
            ...
            <p>I'm an American expat currently living in Uppsala, Sweden. I received my bachelor's degree in Linguistics
              ...
              <a href="https://www.goodreads.com/user/show/5594694-drew-perkins" {...linkProps}> reading</a> a book,
              <a href="https://letterboxd.com/drewperk/" {...linkProps}> watching</a> a movie,
          ...
          <div className="description">
            ...
            <p>I have a published <a href="https://uu.diva-portal.org/smash/get/diva2:1437921/FULLTEXT01.pdf" {...linkProps}>thesis </a>
              and am also featured in <a href="http://www.semantic-web-journal.net/content/survey-english-entity-linking-wikidata" {...linkProps}>Survey on English Entity Linking on Wikidata</a>.
              Right now, I work for <a href="https://softrobot.io/our-story/" {...linkProps}>SoftRobot</a>, a software company that specializes in AI. Our flagship product, known as <a href="https://aiida.io/" target="_blank" rel="noopener noreferrer">Aiida</a>,
              ...
              new and old, to get us closer to our company goals. I have been working with Python for 5 years and
              Typescript/React for the past 3 years. My CV can be found <a href="https://drive.google.com/file/d/1CNUz6OIj4cQHNC8jQYANLsvebN7y7c6Z/view?usp=sharing" {...linkProps}>here</a>.
            </p>
          </div>
          <div className="heading">
            <h1>Tech Stack</h1>
