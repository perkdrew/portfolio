      ...
      <div id="app-header">
          <div className="header">
              <h1>
                  ...
                  <span className="position">Fullstack Developer and Machine Learning Engineer @ <a className="company" href="https://softrobot.io/" target="_blank" rel="noopener noreferrer">SoftRobot</a></span>
              </h1>
              <div className="header-icons">
                  <a aria-label="My Linkedin" target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/drewperk"><i className="icon fab fa-linkedin" aria-hidden="true"/> </a>
                  <a aria-label="My Twitter" target="_blank" rel="noopener noreferrer" href="https://twitter.com/PerkDrew"><i className="icon fab fa-twitter" aria-hidden="true"/> </a>
